...
<section id="menu">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">District-İd</th>
        <th scope="col">Title-İd</th>
        <th scope="col">Unit-İd</th>
  ...
  <tbody>
      ...
      <td>'.$phonenumber.'</td>
      <td>
    <button ><a href="updateemployee.php?updateid='.$id.'">Update</a></button>
        <button ><a href="deleteemployee.php?
        deleteid='.$id.'">Delete</a><button ><a href="employee.php">Add user</a>
    </button>
