...
if(isset($_POST['submit'])){
  ...
  $admin = $_SESSION['uname'];
    ...
    $sql="INSERT INTO employee (id,first_name,last_name,district_id,title_id,unit_id,address,phonenumber,admin_id) VALUES ('$id','$first_name','$last_name','$district_id','$title_id','$unit_id','$address','$phonenumber','$admin')";
...
<section id="menu">
    ...
    <form id="iletisim2" method="post">
        ...
        <div class="form-group col-md-8">
            ...
            <input type="text" name="id" placeholder="Tc" class="form-control" id="inputCity">
          </div>
          <div class="form-group col-md-8">
            <label for="inputCity">FirstName</label>
            <input type="text" name="firstname" placeholder="First-Name" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">LastName</label>
            <input type="text" name="lastname" placeholder="Last-Name" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">District_İd</label>
            <input type="text" name="districtid" placeholder="District-İd" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">Title_İd</label>
            <input type="text" name="titleid" placeholder="Title-İd" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">Unit_İd</label>
            <input type="text" name="unitid" placeholder="Unit-İd" class="form-control" id="inputCity">
          </div>
          <div class="form-group col-md-8">
            <label for="inputCity">Adres</label>
            <input type="text" name="adress" placeholder="Adres" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">PhoneNumber</label>
            <input type="text" name="number" placeholder="PhoneNumber" class="form-control" id="inputCity">
          </div>
          <div class="form-group col-md-8">
            <label for="inputCity">Admin_İd</label>
            <input type="text" name="admin" placeholder="Admin-İd" class="form-control" id="inputCity" value = <?php echo "".$_SESSION['uname'].""?> >
          </div>
         
         
       <div>
        <input type="submit" name="submit" class="btn btn-primary">
        <button type="submit" class="btn btn-white"><a href="employeedisplay.php">Liste</a>
        </button>
       </div>
        </div>
    </form>
