...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO project (name,description,admin_id) VALUES ('$name','$description','$admin')";
    ...
    <form id="iletisim2" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-8">
            ...
            <input type="text" name="projectname" placeholder="City" class="form-control" id="inputCity">
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">Description</label>
            <input type="text" name="description" placeholder="City" class="form-control" id="inputCity">
          </div>
        ...
        <button type="submit" class="btn btn-white"><a href="projectdisplay.php">Liste</a>
        </button>
        </div>
    </form>
    <br>
