...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO title (name,admin_id) VALUES ('$name','$admin')";
    ...
    <form id="iletisim2" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-8">
            ...
            <input type="text" name="title" placeholder="Title" class="form-control" id="inputCity">
          </div>
        ...
        <button type="submit" class="btn btn-white"><a href="titledisplay.php">Liste</a>
        </button>
        </div>
    </form>
