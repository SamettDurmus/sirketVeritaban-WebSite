...
<section id="menu">
  ...
  <tbody>
      ...
      <td>'.$birthday.'</td>
      <td>
    <button ><a href="updatechild.php?updateid='.$id.'">Update</a></button>
        <button ><a href="deletechild.php?
        deleteid='.$id.'">Delete</a><button ><a href="child.php">Add user</a>
    </button>
