...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO province (name,admin_id) VALUES ('$name','$admin')";
    ...
    <form id="iletisim2" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-8">
            ...
            <input type="text" name="province" placeholder="City" class="form-control" id="inputCity">
          </div>
        ...
        <button type="submit" class="btn btn-white"><a href="provincedisplay.php">Liste</a>
        </button>
        </div>
    </form>
