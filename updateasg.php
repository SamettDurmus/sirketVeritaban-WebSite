...
if(isset($_POST['submit'])){
    ...
    $sql="Update assignment set id=$id,project_id='$project_id',employee_id='$employee_id',start_date='$start_date',end_date='$end_date' where id=$id";
    $result=pg_query($con, $sql);
    ...
    <form id="iletisim2" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-8">
            ...
            <input type="text" name="projectid" placeholder="City" class="form-control" id="inputCity" value =<?php echo $project_id?>>
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">Employee-İd</label>
            <input type="text" name="employeeid" placeholder="City" class="form-control" id="inputCity" value =<?php echo $employee_id?>>
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">Start-Date</label>
            <input type="date" name="startdate" placeholder="City" class="form-control" id="inputCity" value =<?php echo $start_date?>>
          </div>
            <div class="form-group col-md-8">
            <label for="inputCity">End-Date</label>
            <input type="date" name="enddate" placeholder="City" class="form-control" id="inputCity" value =<?php echo $end_date?>>
          </div>
     ...
     <button type="submit" name="submit" ><a href="assignmentdisplay.php">Geri</a> </button>
       </div>
    </div>
    </form>
    <br>
